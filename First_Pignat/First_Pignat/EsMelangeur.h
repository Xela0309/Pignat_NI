...
private:
	...
	int m_nEtat; //définit l'état du grafcet (numéro d'étape)
	int m_durée_malax; //définit le temps écoulé de l'opération de malaxage
	int m_durée_refroid; //définit le temps écoulé de l'opération de refroidissement
...
public:
	...
	int32 fermerEsMelangeur();
		...
		** L'automatitien demande à ce que TOUTES les entrées
	...
	void afficherEntrees();
		...
		/*
		** Restitution des données numériques
		** L'automatitien demande à ce que TOUTES les sorties
